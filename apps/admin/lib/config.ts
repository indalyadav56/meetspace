...
/** Soft pill = `bg`/`text` token pair used across badges. */
...
export const PLANS: Record<PlanId, Tone & { price: number }> = {
  free: {
    label: "Free",
    price: 0,
...
export const WORKSPACE_STATUS: Record<WorkspaceStatus, Tone> = {
  active: {
    label: "Active",
...
export const USER_STATUS: Record<UserStatus, Tone> = {
  active: {
    label: "Active",
    soft: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
    dot: "bg-emerald-500",
